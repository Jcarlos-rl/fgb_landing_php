        ...
        <div class="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-2">
            <div class="brand_catalogue w-full rounded shadow-lg p-4 flex flex-col gap-3 lg:gap-5 md:flex-row cursor-pointer hover:bg-fgb-blue-dark [&>div>p.text-lg]:hover:text-fgb-blue-light [&>div>p.text-xs]:hover:text-slate-100 bg-fgb-blue-dark">
                <div class="w-[60px] h-[60px] flex justify-center items-center bg-slate-100 rounded p-2">
                    <img class="object-contain h-full w-full" src="/logo.webp" alt="Logo">
                </div>
                <div>
                    <p class="text-lg font-bold text-fgb-blue-light">BGS</p>
                    <p class="text-xs text-slate-100">2 catálogos</p>
                </div>
            </div>
            <div class="brand_catalogue w-full rounded shadow-lg p-4 flex flex-col gap-3 lg:gap-5 md:flex-row cursor-pointer hover:bg-fgb-blue-dark [&>div>p.text-lg]:hover:text-fgb-blue-light [&>div>p.text-xs]:hover:text-slate-100">
                ...
                <div>
                    <p class="text-lg font-bold text-fgb-blue">Truper</p>
                    <p class="text-xs text-slate-400">3 catálogos</p>
                </div>
            </div>
            <div class="brand_catalogue w-full rounded shadow-lg p-4 flex flex-col gap-3 lg:gap-5 md:flex-row cursor-pointer hover:bg-fgb-blue-dark [&>div>p.text-lg]:hover:text-fgb-blue-light [&>div>p.text-xs]:hover:text-slate-100">
                <div class="w-[60px] h-[60px] flex justify-center items-center bg-slate-100 rounded p-2">
                ...
                <div>
                    <p class="text-lg font-bold text-fgb-blue">Urrea</p>
                    <p class="text-xs text-slate-400">1 catálogos</p>
                </div>
            </div>
            <div class="brand_catalogue w-full rounded shadow-lg p-4 flex flex-col gap-3 lg:gap-5 md:flex-row cursor-pointer hover:bg-fgb-blue-dark [&>div>p.text-lg]:hover:text-fgb-blue-light [&>div>p.text-xs]:hover:text-slate-100">
                <div class="w-[60px] h-[60px] flex justify-center items-center bg-slate-100 rounded p-2">
                ...
                <div>
                    <p class="text-lg font-bold text-fgb-blue">Goni</p>
                    <p class="text-xs text-slate-400">3 catálogos</p>
                </div>
            </div>
        </div>
            ...
            <div class="rounded shadow-md p-5 mb-10">
                <div class="grid grid-cols-1 md:grid-cols-6 items-center">
                    <div class="flex items-center gap-3 md:col-span-2">
                        ...
                        <p class="text-fgb-blue font-medium">BGS.pdf</p>
                    </div>
                    <p class="md:col-span-1 lg:col-span-2 my-5 md:my-0 font-medium text-fgb-blue">BGS</p>
                    <div class="flex gap-3 md:col-span-2">
                        <a href="/catalogos/BGS.pdf" target="_blank" download="BGS.pdf" class="rounded-md text-fgb-blue border-solid border-2 py-4 px-8">Dercargar catálogo</a>
                        <button data-id="BGS.pdf" class="viewCatalogue bg-fgb-blue-dark rounded-md text-white py-4 px-8 shadow-md shadow-fgb-blue-dark hover:bg-fgb-blue-light hover:shadow-fgb-blue-light">Ver catálogo</button>
                    </div>
                </div>
            </div>
            <div class="rounded shadow-md p-5 mb-10">
                <div class="grid grid-cols-1 md:grid-cols-6 items-center">
                    <div class="flex items-center gap-3 md:col-span-2">
                        ...
                        <p class="text-fgb-blue font-medium">FireShot.pdf</p>
                    </div>
                    <p class="md:col-span-1 lg:col-span-2 my-5 md:my-0 font-medium text-fgb-blue">BGS</p>
                    <div class="flex gap-3 md:col-span-2">
                        <a href="/catalogos/FireShot.pdf" target="_blank" download="FireShot.pdf" class="rounded-md text-fgb-blue border-solid border-2 py-4 px-8">Dercargar catálogo</a>
                        <button data-id="FireShot.pdf" class="viewCatalogue bg-fgb-blue-dark rounded-md text-white py-4 px-8 shadow-md shadow-fgb-blue-dark hover:bg-fgb-blue-light hover:shadow-fgb-blue-light">Ver catálogo</button>
                    </div>
                </div>
            </div>
        </section>
